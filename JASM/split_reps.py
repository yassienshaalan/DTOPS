...
def main():
  ...
  indices_file = os.path.join(prefix,splits_folder, 'train_indices_%d.npy' % r)
  
  if os.path.exists(indices_file):
    
    train = np.load(indices_file)
    valid = np.load(os.path.join(prefix, splits_folder, 'valid_indices_%d.npy' % r))
    test = np.load(os.path.join(prefix, splits_folder, 'test_indices_%d.npy' % r))
  else:
    ...
    np.save(os.path.join(prefix, splits_folder, 'train_indices_%d.npy' % r), train)
    np.save(os.path.join(prefix, splits_folder, 'valid_indices_%d.npy' % r), valid)
    np.save(os.path.join(prefix, splits_folder, 'test_indices_%d.npy' % r), test)
