...
_sym_db.RegisterEnumDescriptor(_LAYER_LOSSFUNCTION)
...
_sym_db.RegisterEnumDescriptor(_PARAMETER_INITIALIZATION)
...
_sym_db.RegisterEnumDescriptor(_HYPERPARAMS_DECAY)
...
_sym_db.RegisterEnumDescriptor(_HYPERPARAMS_ADAPT)
...
_sym_db.RegisterEnumDescriptor(_OPERATION_OPTIMIZER)
...
_DATASET = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=True, default_value=_b("2G").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      ...
      number=4, type=9, cpp_type=9, label=1,
      has_default_value=True, default_value=_b("4G").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      ...
      number=5, type=9, cpp_type=9, label=1,
      has_default_value=True, default_value=_b("deepnet").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
...
_sym_db.RegisterMessage(Layer.DataField)
...
_sym_db.RegisterMessage(Parameter.Convolution)
...
Operation = _reflection.GeneratedProtocolMessageType('Operation', (_message.Message,), dict(
  ...
  StopCondition = _reflection.GeneratedProtocolMessageType('StopCondition', (_message.Message,), dict(
...
_sym_db.RegisterMessage(Operation.StopCondition)
...
_sym_db.RegisterMessage(Dataset.Data)
